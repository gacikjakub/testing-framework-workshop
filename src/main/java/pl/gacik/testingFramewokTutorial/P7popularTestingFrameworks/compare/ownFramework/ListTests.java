...
import pl.gacik.testingFramewokTutorial.P7popularTestingFrameworks.compare.ownFramework.DataProvideManager.DataProvider;
...
public class ListTests extends TestClass {
    ...
    @DataProvider(name = "listsImplementation")
    Object[][] listImplementations() {
        return new Object[][] {{new ArrayList<>()}, {new LinkedList<>()}};
    }

    @Test(dataProvider = "listsImplementation")
    public static void addElementToEmptyListTest(List<String> list) {
        ...
        //then
        SoftAssert.assertTrue(wasAdded, "Element couldn't be added");
        SoftAssert.assertEquals(onPositionWhereHasBeenAdded, "first", "Last element is not correct");
    }
    ...
    public static void addElementToListOnLastPositionTest(List<String> list) {
        ...
        //then
        SoftAssert.assertTrue(wasAdded, "Element couldn't be added");
        SoftAssert.assertEquals(onPositionWhereHasBeenAdded, "last", "Last element is not correct");
    }
    ...
    public static void addSameElementTwoTimesTest(List<String> list) {
        ...
        // then
        SoftAssert.assertTrue(wasAdded, "Same value has not been added second time");
        SoftAssert.assertEquals(second, phrase, "Value added second time is not correct");
        SoftAssert.assertEquals(first, phrase, "Value added second time is not the same as first one");
    }
    ...
    public static void addElementToListOnCertainPositionTest(List<String> list) {
        ...
        // when
            ...
            list.add(1, text);
        // then
        SoftAssert.assertEquals(list.get(1), text, "Element pos 1 is not correct");
    }

    @Test(dataProvider = "listsImplementation", expectedException = IndexOutOfBoundsException.class)
    ...
    public static void addAllShouldAddGivenCollectionAtTheEndOfChangingListTest(List<String> list) {
        ...
        // then
        SoftAssert.assertTrue(wasAdded, "Collection has not been added");
        SoftAssert.assertEquals(list.get(1), FIRST_TO_ADD, "Added first element is not correct");
        SoftAssert.assertEquals(list.get(3), LAST_TO_ADD, "Added last element is not correct");
    }
    ...
    public static void addAllShouldPropertlyAddCollectionToEmptyListTest(List<String> list) {
        ...
        // then
        SoftAssert.assertTrue(wasAdded, "Collection has not been added");
        SoftAssert.assertEquals(list.get(0), FIRST_TO_ADD, "Added first element is not correct");
        SoftAssert.assertEquals(list.get(2), LAST_TO_ADD, "Added last element is not correct");
    }

    @Test(dataProvider = "listsImplementation", expectedException = NullPointerException.class)
    ...
    public static void addAllShouldPropertlyAddCollectionInTheMiddleOfList(List<String> list) {
        ...
        SoftAssert.assertEquals(list.get(1), FIRST_TO_ADD, "Added first element is not correct");
        SoftAssert.assertEquals(list.get(3), LAST_TO_ADD, "Added last element is not correct");
        SoftAssert.assertEquals(list.get(4), willBeLast, "Last element before add before them is not on last position after add");
    }
    ...
    public static void clearShouldRemoveAllElementsFromListTest(List<String> list) {
        ...
        list.clear();
        // then
        SoftAssert.assertFalse(list.contains(elemToAdd), "List contain element added before clear");
    }
    ...
    public static void clearShouldChangeSizeToZeroTest(List<String> list) {
        ...
        list.clear();
        // then
        SoftAssert.assertEquals(list.size(), 0, "List contain element added before clear");
    }
